...
const ptTerms = {
  ...
  s1Body: 'Estes Termos do Serviço ("Termos") regem a sua utilização de {{brand}} (o "Serviço"), uma plataforma web de conversão de ficheiros operada a partir da Alemanha por Arwand Moobed Mehdiabadi, Volmerswerther Str. 346, 40221 Düsseldorf. Ao criar uma conta, completar uma compra ou usar o Serviço de qualquer forma, confirma que leu, compreendeu e aceitou estar legalmente vinculado por estes Termos. Se não concordar, não deve usar o Serviço. Podemos atualizar estes Termos conforme indicado na secção 14, e o uso continuado após as alterações entrarem em vigor constitui aceitação.',
