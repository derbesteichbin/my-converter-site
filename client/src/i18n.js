...
const en = {
  ...
  seo: {
    ...
    registerDesc: "Create a free account to start converting files. No credit card needed to sign up — pay only for the conversions you use. Sign up by email or with Google.",
  ...
  home: {
    ...
    reviewsEditCta: "Edit review",
    reviewsEditLimitReached: "You've reached the maximum number of edits for your review.",
    reviewsEditsLeftSingular: "1 edit left",
    reviewsEditsLeftPlural: "{{count}} edits left",
    reviewsYours: "Your review",
    reviewsEditModalTitle: "Edit your review",
    reviewsEditSubmit: "Save changes",
    reviewsEditThanks: "Your review has been updated.",
    reviewsSignInCta: 'Sign in to leave a review',
    reviewsModalTitle: 'Share your experience',
    reviewsModalSubtitle: 'Help others by telling us what you think of {{brand}}.',
    reviewsRatingLabel: 'Your rating',
    reviewsCommentLabel: 'Your review (optional)',
    reviewsCommentPlaceholder: 'What did you like? What could be better?',
    reviewsCharsLeft: '{{n}} characters left',
  ...
  categoryDescriptions: {
    ...
    GIF: 'Create animated GIFs from video and images, turn GIFs back into video, and compress GIF files.',
  ...
  tool: {
    ...
    confirmBatchBodySingular: 'This will convert 1 file and use 1 credit. You have {{remaining}} credits remaining.',
    confirmBatchBodyPlural: 'This will convert {{files}} files and use {{credits}} credits. You have {{remaining}} credits remaining.',
    confirmBtn: 'Confirm',
    uploadFolder: 'Upload a folder',
    uploadFolderHint: 'All files in the folder will be converted to your chosen format.',
    uploadFiles: 'Upload multiple files',
    uploadFilesHint: 'Select several files to convert them all at once.',
    folderNoneMatched: 'No files matched. This tool accepts {{formats}} files.',
    folderFiltered: '{{matched}} files matched and will be converted, {{skipped}} files were skipped because they are not {{formats}} files.',
    folderAdded: 'Files added: {{count}}',
    batchSummaryFiles: 'Files selected: {{count}}',
    batchSummaryCost: 'Total credits: {{count}}',
    buyBtn: 'Buy',
  ...
  dash: {
    ...
    referBody: "Share your link and get 2 conversion credits for each friend who signs up and makes their first purchase.",
    copy: 'Copy',
  ...
  pricing: {
    ...
    promoInvalid: "This promo code doesn't exist or is no longer valid.",
    promoUnavailable: 'This promotion is temporarily unavailable. Please try again later.',
  ...
  faq: {
    ...
    a3: "{{brand}} uses a prepaid credit model — no subscriptions, no recurring charges. Each standard conversion costs 1 credit. Smart Functions are priced by usage: Text-to-Speech costs 1 credit per 1000 input characters (rounded up), and Speech-to-Text plus Auto Subtitle Generator cost 1 credit per 5 minutes of audio or video duration (rounded up). Failed conversions are always free — if our processor returns an error, no credit is deducted. Credits never expire and roll over indefinitely. You can view your balance and full transaction history in your Dashboard, and earn 2 bonus credits for each friend who signs up with your referral link and makes their first purchase.",
  ...
  apiDocs: {
    ...
    seoDesc: 'ConvertAnyFormat REST API documentation. Code examples in cURL, JavaScript, and Python.',
    pageTitle: 'API Documentation',
    pageIntro: 'Integrate file conversion into your applications with our REST API. Generate an API key from your',
    pageIntroLinkText: 'Dashboard',
    copyBtn: 'Copy',
    copiedToast: 'Copied!',
    navDocs: 'Documentation',
    navConversion: 'Conversion APIs',
    navSpecific: 'Specific APIs',
    navCompression: 'Compression APIs',
    navOverview: 'API Overview',
    navAuth: 'Authentication',
    navEndpoints: 'Endpoints',
    navExamples: 'Code Examples',
    navRateLimits: 'Rate Limits',
    navFileConversion: 'File Conversion API',
    navImageConversion: 'Image Conversion API',
    navAudioConversion: 'Audio Conversion API',
    navDocumentConversion: 'Document Conversion API',
    navPdfConversion: 'PDF Conversion API',
    navMp4Conversion: 'MP4 Conversion API',
    navVideoConversion: 'Video Conversion API',
    navJpgToPdf: 'JPG to PDF API',
    navVideoToMp3: 'Video to MP3 API',
    navHeicToJpg: 'HEIC to JPG API',
    navPdfToJpg: 'PDF to JPG API',
    navWebpToPng: 'WebP to PNG API',
    navPdfToWord: 'PDF to Word API',
    navMp4ToMp3: 'MP4 to MP3 API',
    navWebpToJpg: 'WebP to JPG API',
    navWordToPdf: 'Word to PDF API',
    navHtmlToPdf: 'HTML to PDF API',
    navWebsiteScreenshot: 'Website Screenshot API',
    navVideoCompression: 'Video Compression API',
    navCompressPdf: 'Compress PDF API',
    navImageCompression: 'Image Compression API',
    overviewTitle: 'API Overview',
    overviewIntro: 'The ConvertAnyFormat API allows you to programmatically convert files between 50+ formats. The workflow is simple:',
    workflowUpload: 'Upload',
    workflowUploadDesc: 'a file with your desired output format',
    workflowPoll: 'Poll',
    workflowPollDesc: "the job status until it's done",
    workflowDownload: 'Download',
    workflowDownloadDesc: 'the converted file',
    baseUrl: 'Base URL:',
    authTitle: 'Authentication',
    authBody: 'All requests require authentication via a session cookie. Log in through the web interface or pass your JWT token as a cookie header.',
    endpointsTitle: 'Endpoints',
    endpointConvert: 'Upload and start conversion',
    endpointPdfTool: 'PDF operations (merge, split, compress)',
    endpointJobStatus: 'Check job status',
    endpointJobsList: 'List all your jobs',
    endpointDownload: 'Download converted file',
    endpointDownloadZip: 'Download multiple files as ZIP',
    endpointMetadata: 'Extract file metadata',
    paramsTitle: 'Parameters for POST /api/convert',
    paramField: 'Field',
    paramType: 'Type',
    ...
    paramFileDesc: 'The file to convert (multipart form, max 200MB)',
    paramOutputFormatDesc: 'Target format (e.g. docx, png, mp3)',
    paramToolSlugDesc: 'Tool identifier (e.g. pdf-to-word, jpg-to-png)',
    paramNotifyEmailDesc: 'Set to "true" to receive email when done',
    jobResponseTitle: 'Job status response',
    jobResponseId: 'Job ID',
    jobResponseStatus: 'pending, processing, done, or failed',
    jobResponseDownloadUrl: 'Available when status is "done"',
    jobResponseOutputSize: 'Output file size in bytes (when done)',
    examplesTitle: 'Code Examples',
    exampleStep1: '1. Upload and convert a file',
    exampleStep2: '2. Check conversion status',
    exampleStep3: '3. Download the result',
    rateLimitsTitle: 'Rate Limits',
    rateLimitsPlan: 'Plan',
    rateLimitsLimit: 'Limit',
    rateLimitsFileSize: 'File Size',
    rateLimitsFree: 'Free',
    rateLimitsFreeLimit: "No credits included",
    rateLimitsPayg: 'Pay-as-you-go',
    rateLimitsPaygLimit: 'Credits never expire',
    rateLimitsBusiness: 'Business',
    rateLimitsBusinessLimit: 'Unlimited',
    rateLimitsBusinessSize: 'Custom',
    rateLimitsNote: 'Files are automatically deleted after 24 hours.',
    availableTitle: 'Available Conversion APIs',
    availableIntroPart1: 'All conversions use the same',
    availableIntroPart2: 'endpoint. Set the',
    availableIntroPart3: 'parameter to the desired tool.',
  },
  metadataPage: {
    title: "File Info",
  ...
  profile: {
    ...
    bonusCreditsValue: "{{count}} extra conversions earned from referrals",
  ...
  report: {
    ...
    intro: "Found something that isn't working? Let us know and we'll fix it.",
    messageLabel: 'What went wrong?',
    messagePlaceholder: 'Describe the problem…',
    charsLeft: '{{n}} characters left',
    emailLabel: 'Your email (optional)',
    emailPlaceholder: 'you@example.com',
    emailHint: "Add your email if you'd like a reply.",
    submit: 'Send report',
    submitting: 'Sending…',
    cancel: 'Cancel',
  ...
  // Dismissible "Install app" pill, shown only when the browser fires
  // beforeinstallprompt (Chromium). iOS uses Safari's own Add to Home Screen.
  install: {
    text: "Add ConvertAnyFormat to your home screen",
    action: "Install",
    dismiss: "Dismiss",
    aria: "Install app",
  },
  ...
  toolDescriptions: {
    ...
    "video-to-mp3": "Extract the audio track from any video and save it as MP3, WAV, AAC, OGG, or FLAC.",
    "mp4-converter": "Convert almost any video — MOV, AVI, MKV, WebM, FLV, and more — into a universally playable MP4.",
    "video-converter": "Convert video between MP4, AVI, MOV, MKV, and WebM. One tool for every common video format.",
    "jfif-to-png": "Convert JFIF images (a common JPEG variant) to PNG for wider compatibility and transparency support.",
    "heic-to-pdf": "Turn iPhone HEIC photos into a PDF document — perfect for sharing or printing image collections.",
    "image-compressor": "Shrink JPG, PNG, and GIF images to a smaller file size while keeping the same format and good quality.",
    "jpeg-compressor": "Reduce the file size of JPEG photos without changing the format — ideal for faster websites and email.",
    "png-compressor": "Compress PNG images to a smaller file size while preserving transparency and sharp detail.",
    "pdf-to-epub": "Convert PDF documents to EPUB ebooks so they reflow nicely on e-readers, phones, and tablets.",
    "epub-to-pdf": "Convert EPUB ebooks to PDF for easy printing and consistent viewing on any device.",
    "document-converter": "Convert documents between PDF, Word, ODT, RTF, TXT, and HTML. One tool for every common document format.",
    "ebook-converter": "Convert ebooks between EPUB, MOBI, AZW3, FB2, and PDF for any e-reader or app.",
    "video-to-gif": "Turn a video clip into an animated GIF — great for reactions, demos, and social media.",
    "mp4-to-gif": "Convert MP4 video clips into animated GIFs that play anywhere without a video player.",
    "webm-to-gif": "Convert WebM video into an animated GIF for easy sharing on chat and social platforms.",
    "mov-to-gif": "Convert QuickTime MOV clips into animated GIFs ready to share anywhere.",
    "avi-to-gif": "Convert AVI video into a lightweight animated GIF in seconds.",
    "gif-to-mp4": "Convert animated GIFs to MP4 (or WebM) video for smaller files and smoother playback.",
    "image-to-gif": "Turn a JPG, PNG, WebP, or BMP image into a GIF file, ready for the web.",
    "gif-compressor": "Reduce the file size of animated GIFs while keeping the animation smooth.",
